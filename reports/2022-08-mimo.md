![Mimo DeFi](/static/17ec9f3df2d390d605a4e1097de116cd/4e333/mimo.jpg)
...
*   [Low Risk and Non-Critical Issues](#low-risk-and-non-critical-issues)
    ...
    *   [N‑05 Constant redefined elsewhere](#n05--constant-redefined-elsewhere)
...
[](#h-02-automation--management-can-be-set-for-not-yet-existing-vault)[\[H-02\] Automation / management can be set for not yet existing vault](https://github.com/code-423n4/2022-08-mimo-findings/issues/68)
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
_There are 2 instances of this issue. (For in-depth details on this and all further low and non-critical items with multiple instances, see the warden’s [full report](https://github.com/code-423n4/2022-08-mimo-findings/issues/118).)_
...
[https://github.com/code-423n4/2022-08-mimo/blob/eb1a5016b69f72bc1e4fd3600a65e908bd228f13/contracts/actions/managed/MIMOManagedRebalance.sol#L14](https://github.com/code-423n4/2022-08-mimo/blob/eb1a5016b69f72bc1e4fd3600a65e908bd228f13/contracts/actions/managed/MIMOManagedRebalance.sol#L14)
...
[](#g-02-multiple-accesses-of-a-mappingarray-should-use-a-local-variable-cache)\[G-02\] Multiple accesses of a mapping/array should use a local variable cache
--------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-06-unchecking-arithmetics-operations-that-cant-underflowoverflow)\[G-06\] Unchecking arithmetics operations that can’t underflow/overflow
-----------------------------------------------------------------------------------------------------------------------------------------------
...
**Note : This is describing an optimization that the sponsor already chose to ignore, to be thorough: [https://github.com/code-423n4/2022-08-mimo/tree/main/docs/#for-loop-syntax](https://github.com/code-423n4/2022-08-mimo/tree/main/docs/#for-loop-syntax)**
...
[](#g-09-incrementsdecrements-can-be-unchecked-in-for-loops)\[G-09\] Increments/decrements can be unchecked in for-loops
------------------------------------------------------------------------------------------------------------------------
...
_(For in-depth details on each of the following sub-sections, see the warden’s [full report](https://github.com/code-423n4/2022-08-mimo-findings/issues/74).)_

### [](#121-use-assembly-for-math-add-sub-mul-div)12.1. Use assembly for math (add, sub, mul, div)

Use assembly for math instead of Solidity. You can check for overflow/underflow in assembly to ensure safety. If using Solidity versions < 0.8.0 and you are using Safemath, you can gain significant gas savings by using assembly to calculate values and checking for overflow/underflow.

### [](#122-use-assembly-to-check-for-address0)12.2. Use assembly to check for address(0)

### [](#123-use-assembly-to-write-storage-values)12.3. Use assembly to write storage values
...
_Mitigation review by horsefacts_
...
### [](#h-01-mimoemptyvaultsol-executeoperation-does-not-transfer-the-vault-leftover-assets-to-the-owner-it-is-locked-in-the-mimoemptyvault-1)\[H-01\] **MIMOEmptyVault.sol executeOperation() does not transfer the Vault leftover assets to the owner, it is locked in the MIMOEmptyVault**
...
### [](#h-02-automation--management-can-be-set-for-not-yet-existing-vault-1)\[H-02\] **Automation / management can be set for not yet existing vault**
...
### [](#h-03-registrysol-fails-to-deliver-expected-functionality-1)\[H-03\] **Registry.sol fails to deliver expected functionality**
...
### [](#h-04-incorrect-implementation-of-access-control-in-mimoproxyexecute-1)\[H-04\] **Incorrect implementation of access control in MIMOProxy:execute**
...
### [](#m-01-vault-rebalancing-can-be-exploited-if-two-vaults-rebalance-into-the-same-vault-1)\[M-01\] **Vault rebalancing can be exploited if two vaults rebalance into the same vault**
...
### [](#m-02-malicious-targets-can-manipulate-mimoproxy-permissions-1)\[M-02\] **Malicious targets can manipulate MIMOProxy permissions**
...
### [](#m-03-malicious-manipulation-of-gas-reserve-can-deny-access-to-mimoproxy-1)\[M-03\] **Malicious manipulation of gas reserve can deny access to MIMOProxy**
...
### [](#m-04-persisted-msgvalue-in-a-loop-of-delegate-calls-can-be-used-to-drain-eth-from-your-proxy-1)\[M-04\] **Persisted msg.value in a loop of delegate calls can be used to drain ETH from your proxy**
...
### [](#m-05-mimomanagedrebalancesolrebalance-calculates-managerfee-incorrectly-1)\[M-05\] **MIMOManagedRebalance.sol#rebalance calculates managerFee incorrectly**
...
### [](#m-06-proxyfactory-can-circumvent-proxyregistry-1)\[M-06\] **ProxyFactory can circumvent ProxyRegistry**
...
### [](#m-07-vault-owner-can-front-run-rebalance-to-lower-incentives)\[M-07\] Vault owner can front run rebalance to lower incentives
...
### [](#m-08-if-a-mimoproxy-owner-destroys-their-proxy-they-cannot-deploy-another-from-the-same-address-1)\[M-08\] If a MIMOProxy owner destroys their proxy, they cannot deploy another from the same address
...
### [](#mh-01-missing-check-for-uninitialized-vault-in-mimomanagedactionsetmanagement)\[M.H-01\] Missing check for uninitialized vault in `MIMOManagedAction#setManagement`
...
### [](#mm-01-missing-whennotpaused-modifier-on-flash-loan-callbacks)\[M.M-01\] Missing `whenNotPaused` modifier on flash loan callbacks
...
### [](#mn-01-emit-events-in-mimopausable)\[M.N-01\] Emit events in `MIMOPausable`
