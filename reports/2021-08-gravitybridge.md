![Althea Gravity Bridge](/static/b5b313495a5eba46bc8fa3672f6c8fc4/4e333/althea.jpg)
...
*   [High Risk Findings (4)](#high-risk-findings-4)
    ...
    *   [\[H-01\] Cannot actually submit evidence](#h-01-cannot-actually-submit-evidence)
    *   [\[H-02\] Freeze Bridge via Non-UTF8 Token Name/Symbol/Denom](#h-02-freeze-bridge-via-non-utf8-token-namesymboldenom)
    *   [\[H-03\] Freeze The Bridge Via Large ERC20 Names/Symbols/Denoms](#h-03-freeze-the-bridge-via-large-erc20-namessymbolsdenoms)
    *   [\[H-04\] Large Validator Sets/Rapid Validator Set Updates May Freeze the Bridge or Relayers](#h-04-large-validator-setsrapid-validator-set-updates-may-freeze-the-bridge-or-relayers)
*   [Medium Risk Findings (4)](#medium-risk-findings-4)
    
    *   [\[M-01\] The function `updateValset` does not have enough sanity checks](#m-01-the-function-updatevalset-does-not-have-enough-sanity-checks)
    *   [\[M-02\] Crash Eth Oracle On Any `LogicCallEvent`](#m-02-crash-eth-oracle-on-any-logiccallevent)
    *   [\[M-03\] Win all relayer rewards](#m-03-win-all-relayer-rewards)
    *   [\[M-04\] Incorrect accounting on transfer-on-fee/deflationary tokens in `Gravity`](#m-04-incorrect-accounting-on-transfer-on-feedeflationary-tokens-in-gravity)
*   [Low Risk Findings (10)](#low-risk-findings-10)
    
    *   [\[L-01\] Direct usage of `ecrecover` allows signature malleability](#l-01-direct-usage-of-ecrecover-allows-signature-malleability)
    *   [\[L-02\] Why nonces are not incrementing by 1 ?](#l-02-why-nonces-are-not-incrementing-by-1-)
    *   [\[L-03\] logic calls can steal tokens](#l-03-logic-calls-can-steal-tokens)
    *   [\[L-04\] Large `ValSets` potentially freezes `Gravity.sol`](#l-04-large-valsets-potentially-freezes-gravitysol)
    *   [\[L-05\] ERC20s that block transfer to particular addresses enable DoS/Censorship](#l-05-erc20s-that-block-transfer-to-particular-addresses-enable-doscensorship)
    *   [\[L-06\] Downcasting Can Freeze The Chain](#l-06-downcasting-can-freeze-the-chain)
    *   [\[L-07\] Validations of parameters](#l-07-validations-of-parameters)
    *   [\[L-08\] SafeMath library is not always used in `Gravity`](#l-08-safemath-library-is-not-always-used-in-gravity)
    *   [\[L-09\] Possible miner incentive for chain reorgs if `ETHBlockDelay` is too small](#l-09-possible-miner-incentive-for-chain-reorgs-if-ethblockdelay-is-too-small)
    *   [\[L-10\] `cumulativePower` check should be inclusive](#l-10-cumulativepower-check-should-be-inclusive)
...
1.  nascent
    ...
    *   [chris\_nascent](https://twitter.com/Chris_8086)
...
[](#h-01-cannot-actually-submit-evidence)[\[H-01\] Cannot actually submit evidence](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/64)
-----------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#h-02-freeze-bridge-via-non-utf8-token-namesymboldenom)[\[H-02\] Freeze Bridge via Non-UTF8 Token Name/Symbol/Denom](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/4)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#h-03-freeze-the-bridge-via-large-erc20-namessymbolsdenoms)[\[H-03\] Freeze The Bridge Via Large ERC20 Names/Symbols/Denoms](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/5)
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
This can be triggered at will and keep the loop in a perpetual state of returning the `GravityError::EthereumRestError(Web3Error::BadResponse( "Failed to get logs!".to_string()))` error. To force the node into this state, you just have to deploy ERC20s generated by the [public function in `Gravity.sol`](https://github.com/althea-net/cosmos-gravity-bridge/blob/92d0e12cea813305e6472851beeb80bd2eaf858d/solidity/contracts/Gravity.sol#L546-L565):
...
[](#h-04-large-validator-setsrapid-validator-set-updates-may-freeze-the-bridge-or-relayers)[\[H-04\] Large Validator Sets/Rapid Validator Set Updates May Freeze the Bridge or Relayers](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/6)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#m-01-the-function-updatevalset-does-not-have-enough-sanity-checks)[\[M-01\] The function `updateValset` does not have enough sanity checks](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/51)
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#m-02-crash-eth-oracle-on-any-logiccallevent)[\[M-02\] Crash Eth Oracle On Any `LogicCallEvent`](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/11)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#m-03-win-all-relayer-rewards)[\[M-03\] Win all relayer rewards](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/7)
------------------------------------------------------------------------------------------------------------------------------------------
...
[](#m-04-incorrect-accounting-on-transfer-on-feedeflationary-tokens-in-gravity)[\[M-04\] Incorrect accounting on transfer-on-fee/deflationary tokens in `Gravity`](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/62)
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#l-01-direct-usage-of-ecrecover-allows-signature-malleability)[\[L-01\] Direct usage of `ecrecover` allows signature malleability](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/61)
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Referenced code: [Gravity.sol#L153](https://github.com/althea-net/cosmos-gravity-bridge/blob/92d0e12cea813305e6472851beeb80bd2eaf858d/solidity/contracts/Gravity.sol#L153)

[SWC-117: Signature Malleability](https://swcregistry.io/docs/SWC-117) [SWC-121: Missing Protection against Signature Replay Attacks](https://swcregistry.io/docs/SWC-121)
...
[](#l-02-why-nonces-are-not-incrementing-by-1-)[\[L-02\] Why nonces are not incrementing by 1 ?](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/32)
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#l-03-logic-calls-can-steal-tokens)[\[L-03\] logic calls can steal tokens](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/25)
-----------------------------------------------------------------------------------------------------------------------------------------------------
...
> 
> Duplicate of [https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/1](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/1)
...
[](#l-04-large-valsets-potentially-freezes-gravitysol)[\[L-04\] Large `ValSets` potentially freezes `Gravity.sol`](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/9)
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#l-05-erc20s-that-block-transfer-to-particular-addresses-enable-doscensorship)[\[L-05\] ERC20s that block transfer to particular addresses enable DoS/Censorship](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/8)
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#l-06-downcasting-can-freeze-the-chain)[\[L-06\] Downcasting Can Freeze The Chain](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/19)
-------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#l-07-validations-of-parameters)[\[L-07\] Validations of parameters](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/31)
-----------------------------------------------------------------------------------------------------------------------------------------------
...
[](#l-08-safemath-library-is-not-always-used-in-gravity)[\[L-08\] SafeMath library is not always used in `Gravity`](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/60)
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#l-09-possible-miner-incentive-for-chain-reorgs-if-ethblockdelay-is-too-small)[\[L-09\] Possible miner incentive for chain reorgs if `ETHBlockDelay` is too small](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/12)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#l-10-cumulativepower-check-should-be-inclusive)[\[L-10\] `cumulativePower` check should be inclusive](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/26)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
*   [\[N-02\] Unhandled reverts from Cosmos to Eth batches can cause _Denial Of Service_](https://github.com/code-423n4/2021-08-gravitybridge-findings/issues/56)
