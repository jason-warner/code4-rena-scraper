![JPEG'd](/static/7f329253bd2b65568b552126935d2b82/4e333/jpegd69.jpg)
...
*   [High Risk Findings (9)](#high-risk-findings-9)
    ...
    *   [\[H-01\] yVault: First depositor can break minting of shares](#h-01-yvault-first-depositor-can-break-minting-of-shares)
    *   [\[H-02\] Existing user’s locked JPEG could be overwritten by new user, causing permanent loss of JPEG funds](#h-02-existing-users-locked-jpeg-could-be-overwritten-by-new-user-causing-permanent-loss-of-jpeg-funds)
    *   [\[H-03\] Update initializer modifier to prevent reentrancy during initialization](#h-03-update-initializer-modifier-to-prevent-reentrancy-during-initialization)
    *   [\[H-04\] Reentrancy issue in `yVault.deposit`](#h-04-reentrancy-issue-in-yvaultdeposit)
    *   [\[H-05\] `yVaultLPFarming`: No guarantee JPEG currentBalance > previousBalance](#h-05-yvaultlpfarming-no-guarantee-jpeg-currentbalance--previousbalance)
    *   [\[H-06\] Setting new controller can break `YVaultLPFarming`](#h-06-setting-new-controller-can-break-yvaultlpfarming)
    *   [\[H-07\] Controller: Strategy migration will fail](#h-07-controller-strategy-migration-will-fail)
    *   [\[H-08\] `StrategyPUSDConvex.balanceOfJPEG` uses incorrect function signature while calling `extraReward.earned`, causing the function to unexpectedly revert everytime](#h-08-strategypusdconvexbalanceofjpeg-uses-incorrect-function-signature-while-calling-extrarewardearned-causing-the-function-to-unexpectedly-revert-everytime)
    *   [\[H-09\] Bad debts should not continue to accrue interest](#h-09-bad-debts-should-not-continue-to-accrue-interest)
*   [Medium Risk Findings (11)](#medium-risk-findings-11)
    
    *   [\[M-01\] When \_lpToken is jpeg, reward calculation is incorrect](#m-01-when-_lptoken-is-jpeg-reward-calculation-is-incorrect)
    *   [\[M-02\] NFTHelper Contract Allows Owner to Burn NFTs](#m-02-nfthelper-contract-allows-owner-to-burn-nfts)
    *   [\[M-03\] reward will be locked in the farm if no LP join the pool at epoch.startBlock](#m-03-reward-will-be-locked-in-the-farm-if-no-lp-join-the-pool-at-epochstartblock-)
    *   [\[M-04\] `setDebtInterestApr` should accrue debt first](#m-04-setdebtinterestapr-should-accrue-debt-first)
    *   [\[M-05\] Rewards will be locked if user transfer directly to pool without using deposit function](#m-05-rewards-will-be-locked-if-user-transfer-directly-to-pool-without-using-deposit-function-)
    *   [\[M-06\] Oracle data feed is insufficiently validated.](#m-06-oracle-data-feed-is-insufficiently-validated)
    *   [\[M-07\] Wrong calculation for `yVault` price per share if decimals != 18](#m-07-wrong-calculation-for-yvault-price-per-share-if-decimals--18)
    *   [\[M-08\] `_swapUniswapV2` may use an improper `path` which can cause a loss of the majority of the rewardTokens](#m-08-_swapuniswapv2-may-use-an-improper-path-which-can-cause-a-loss-of-the-majority-of-the-rewardtokens)
    *   [\[M-09\] The noContract modifier does not work as expected.](#m-09-the-nocontract-modifier-does-not-work-as-expected)
    *   [\[M-10\] Chainlink pricer is using a deprecated API](#m-10-chainlink-pricer-is-using-a-deprecated-api)
    *   [\[M-11\] Division before Multiplication May Result In No Interest Being Accrued](#m-11-division-before-multiplication-may-result-in-no-interest-being-accrued)
*   [Low Risk and Non-Critical Issues](#low-risk-and-non-critical-issues)
    ...
    *   [\[L-02\] Immutable addresses should be 0-checked](#l-02-immutable-addresses-should-be-0-checked)
    *   [\[L-03\] Unbounded loop on array can lead to DoS](#l-03-unbounded-loop-on-array-can-lead-to-dos)
    *   [\[L-04\] Add a timelock and event to critical functions](#l-04-add-a-timelock-and-event-to-critical-functions)
    *   [\[L-05\] Fee in `StrategyPUSDConvex.setPerformanceFee()` should be upper-bounded](#l-05-fee-in-strategypusdconvexsetperformancefee-should-be-upper-bounded)
    *   [\[L-06\] Fee in `NFTVault.setOrganizationFeeRate()`should be upper-bounded](#l-06-fee-in-nftvaultsetorganizationfeerateshould-be-upper-bounded)
    *   [\[L-07\] A magical number should be documented and explained: `1e36`. Use a constant instead](#l-07-a-magical-number-should-be-documented-and-explained-1e36-use-a-constant-instead)
    *   [\[N-01\] Avoid floating pragmas: the version should be locked (preferably at >= `0.8.4`)](#n-01-avoid-floating-pragmas-the-version-should-be-locked-preferably-at--084)
    *   [\[N-02\] Related data should be grouped in a struct](#n-02-related-data-should-be-grouped-in-a-struct)
    *   [\[N-03\] Unused named returns](#n-03-unused-named-returns)
*   [Gas Optimizations](#gas-optimizations)
    
    *   [Table of Contents](#table-of-contents)
    *   [G-01 `NFTEscrow._executeTransfer()`: Cheap Contract Deployment Through Clones](#g-01-nftescrow_executetransfer-cheap-contract-deployment-through-clones)
    *   [G-02 `LPFarming.newEpoch()`: L128 and L133 should be unchecked due to parent if/else condition](#g-02-lpfarmingnewepoch-l128-and-l133-should-be-unchecked-due-to-parent-ifelse-condition)
    *   [G-03 `LPFarming.withdraw()`: L248 should be unchecked due to L243](#g-03-lpfarmingwithdraw-l248-should-be-unchecked-due-to-l243)
    *   [G-04 `LPFarming._withdrawReward()`: `poolInfo[_pid].accRewardPerShare` should get cached](#g-04-lpfarming_withdrawreward-poolinfo_pidaccrewardpershare-should-get-cached)
    *   [G-05 `yVaultLPFarming.withdraw()`: L124 should be unchecked due to L119](#g-05-yvaultlpfarmingwithdraw-l124-should-be-unchecked-due-to-l119)
    *   [G-06 `yVaultLPFarming._withdrawReward()`: `accRewardPerShare` should get cached](#g-06-yvaultlpfarming_withdrawreward-accrewardpershare-should-get-cached)
    *   [G-07 `JPEGLock.unlock()`: use `storage` instead of copying struct in memory L69](#g-07-jpeglockunlock-use-storage-instead-of-copying-struct-in-memory-l69)
    *   [G-08 `FungibleAssetVaultForDAO._collateralPriceUsd()`: `oracle` should get cached](#g-08-fungibleassetvaultfordao_collateralpriceusd-oracle-should-get-cached)
    *   [G-09 `FungibleAssetVaultForDAO._collateralPriceUsd()`: return statement should be unchecked](#g-09-fungibleassetvaultfordao_collateralpriceusd-return-statement-should-be-unchecked)
    *   [G-10 `FungibleAssetVaultForDAO.deposit()`: `collateralAsset` should get cached](#g-10-fungibleassetvaultfordaodeposit-collateralasset-should-get-cached)
    *   [G-11 `FungibleAssetVaultForDAO.repay)`: L184 should be unchecked due to L182](#g-11-fungibleassetvaultfordaorepay-l184-should-be-unchecked-due-to-l182)
    *   [G-12 `FungibleAssetVaultForDAO.withdraw()`: L196 should be unchecked due to L194](#g-12-fungibleassetvaultfordaowithdraw-l196-should-be-unchecked-due-to-l194)
    *   [G-13 `FungibleAssetVaultForDAO.withdraw()`: `collateralAmount` should get cached](#g-13-fungibleassetvaultfordaowithdraw-collateralamount-should-get-cached)
    *   [G-14 `NFTVault._normalizeAggregatorAnswer()`: return statement should be unchecked](#g-14-nftvault_normalizeaggregatoranswer-return-statement-should-be-unchecked)
    *   [G-15 `NFTVault._calculateAdditionalInterest()`: `totalDebtAmount` should get cached](#g-15-nftvault_calculateadditionalinterest-totaldebtamount-should-get-cached)
    *   [G-16 `NFTVault.sol`: `struct PositionPreview` can be tightly packed to save 1 storage slot](#g-16-nftvaultsol-struct-positionpreview-can-be-tightly-packed-to-save-1-storage-slot)
    *   [G-17 `NFTVault.showPosition()`: L659 should be unchecked due to L649](#g-17-nftvaultshowposition-l659-should-be-unchecked-due-to-l649)
    *   [G-18 `NFTVault.showPosition()`: `positions[_nftIndex].liquidatedAt` should get cached](#g-18-nftvaultshowposition-positions_nftindexliquidatedat-should-get-cached)
    *   [G-19 `NFTVault.showPosition()`: Help the optimizer by saving a storage variable’s reference instead of repeatedly fetching it (`positions[_nftIndex]`)](#g-19-nftvaultshowposition-help-the-optimizer-by-saving-a-storage-variables-reference-instead-of-repeatedly-fetching-it-positions_nftindex)
    *   [G-20 `NFTVault.borrow()`: `totalDebtPortion` should get cached](#g-20-nftvaultborrow-totaldebtportion-should-get-cached)
    *   [G-21 `NFTVault.repay()`: L781 should be unchecked due to ternary operator](#g-21-nftvaultrepay-l781-should-be-unchecked-due-to-ternary-operator)
    *   [G-22 `NFTVault.repay()`: `totalDebtPortion` and `totalDebtAmount` should get cached](#g-22-nftvaultrepay-totaldebtportion-and-totaldebtamount-should-get-cached)
    *   [G-23 `Controller.setStrategy()`: boolean comparison L87](#g-23-controllersetstrategy-boolean-comparison-l87)
    *   [G-24 `StrategyPUSDConvex.balanceOfJPEG()`: `jpeg` should get cached](#g-24-strategypusdconvexbalanceofjpeg-jpeg-should-get-cached)
    *   [G-25 `StrategyPUSDConvex.balanceOfJPEG()`: use a `return` statement instead of `break`](#g-25-strategypusdconvexbalanceofjpeg-use-a-return-statement-instead-of-break)
    *   [G-26 `StrategyPUSDConvex.withdraw()`: L281 should be unchecked due to L279](#g-26-strategypusdconvexwithdraw-l281-should-be-unchecked-due-to-l279)
    *   [G-27 `StrategyPUSDConvex.harvest()`: L362 should be unchecked due to L359-L360 and how performanceFee is set L183](#g-27-strategypusdconvexharvest-l362-should-be-unchecked-due-to-l359-l360-and-how-performancefee-is-set-l183)
    *   [G-28 `yVault.earn()`: `token` and `controller` should get cached](#g-28-yvaultearn-token-and-controller-should-get-cached)
    *   [G-29 `yVault.withdraw()`: L178 should be unchecked due to L177](#g-29-yvaultwithdraw-l178-should-be-unchecked-due-to-l177)
    *   [G-30 `yVault.withdraw()`: `token` should get cached](#g-30-yvaultwithdraw-token-should-get-cached)
    *   [G-31 `yVault.withdrawJPEG()`: `farm` should get cached](#g-31-yvaultwithdrawjpeg-farm-should-get-cached)
    *   [G-32 Upgrade pragma to at least 0.8.4](#g-32-upgrade-pragma-to-at-least-084)
    *   [G-33 No need to explicitly initialize variables with default values](#g-33-no-need-to-explicitly-initialize-variables-with-default-values)
    *   [G-34 `> 0` is less efficient than `!= 0` for unsigned integers (with proof)](#g-34--0-is-less-efficient-than--0-for-unsigned-integers-with-proof)
    *   [G-35 `>=` is cheaper than `>`](#g-35--is-cheaper-than-)
    *   [G-36 An array’s length should be cached to save gas in for-loops](#g-36-an-arrays-length-should-be-cached-to-save-gas-in-for-loops)
    *   [G-37 `++i` costs less gas compared to `i++` or `i += 1`](#g-37-i-costs-less-gas-compared-to-i-or-i--1)
    *   [G-38 Increments can be unchecked](#g-38-increments-can-be-unchecked)
    *   [G-39 Use `calldata` instead of `memory`](#g-39-use-calldata-instead-of-memory)
    *   [G-40 Consider making some constants as non-public to save gas](#g-40-consider-making-some-constants-as-non-public-to-save-gas)
    *   [G-41 Public functions to external](#g-41-public-functions-to-external)
    *   [G-42 Reduce the size of error messages (Long revert Strings)](#g-42-reduce-the-size-of-error-messages-long-revert-strings)
    *   [G-43 Use Custom Errors instead of Revert Strings to save Gas](#g-43-use-custom-errors-instead-of-revert-strings-to-save-gas)
...
2.  [hickuphh3](https://twitter.com/HickupH)
3.  [rayn](https://twitter.com/rayn731)
4.  [WatchPug](https://twitter.com/WatchPug_)
5.  [Dravee](https://twitter.com/JustDravee)
6.  TrungOre
7.  [berndartmueller](https://twitter.com/berndartmueller)
8.  [Kenshin](https://twitter.com/nonfungiblenero)
9.  minhquanym
10.  AuditsAreUS
11.  0xDjango
12.  IllIllI
...
14.  Jujic
15.  hyh
16.  [pedroais](https://twitter.com/Pedroais2/)
17.  Kthere
18.  Foundation ([HardlyDifficult](https://twitter.com/HardlyDifficult) and [batu](https://twitter.com/ba2inal/))
19.  0x1f8b
20.  PPrieditis
21.  robee
22.  [Meta0xNull](https://twitter.com/Meta0xNull)
...
29.  [JMukesh](https://twitter.com/MukeshJ_eth)
30.  [catchup](https://twitter.com/catchup22)
31.  kenta
32.  kebabsec (okkothejawa and [FlameHorizon](https://twitter.com/FlameHorizon1))
33.  [ellahi](https://twitter.com/ellahinator)
...
46.  [dy](https://davidyat.es)
47.  [pauliax](https://twitter.com/SolidityDev)
48.  samruna
49.  jayjonah8
50.  [Tomio](https://twitter.com/meidhiwirara)
51.  [0xNazgul](https://twitter.com/0xNazgul)
52.  [0v3rf10w](https://twitter.com/_0v3rf10w)
53.  [securerodd](https://twitter.com/securerodd)
54.  FSchmoede
55.  slywaters
56.  [rokinot](twitter.com/rokinot)
57.  nahnah
58.  sorrynotsorry
59.  dirk\_y
60.  [defsec](https://twitter.com/defsec_)
61.  joshie
62.  peritoflores
...
[](#h-01-yvault-first-depositor-can-break-minting-of-shares)[\[H-01\] yVault: First depositor can break minting of shares](https://github.com/code-423n4/2022-04-jpegd-findings/issues/12)
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Submitted by hickuphh3, also found by 0xDjango, berndartmueller, cmichel, hyh, and WatchPug_

[yVault.sol#L148-L153](https://github.com/code-423n4/2022-04-jpegd/blob/main/contracts/vaults/yVault/yVault.sol#L148-L153)  
...
[](#h-02-existing-users-locked-jpeg-could-be-overwritten-by-new-user-causing-permanent-loss-of-jpeg-funds)[\[H-02\] Existing user’s locked JPEG could be overwritten by new user, causing permanent loss of JPEG funds](https://github.com/code-423n4/2022-04-jpegd-findings/issues/10)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Submitted by hickuphh3, also found by 0x1f8b, AuditsAreUS, Foundation, Kthere, Meta0xNull, rayn, and WatchPug_

[NFTVault.sol#L375](https://github.com/code-423n4/2022-04-jpegd/blob/main/contracts/vaults/NFTVault.sol#L375)  
[JPEGLock.sol#L54-L62](https://github.com/code-423n4/2022-04-jpegd/blob/main/contracts/lock/JPEGLock.sol#L54-L62)  
...
[](#h-03-update-initializer-modifier-to-prevent-reentrancy-during-initialization)[\[H-03\] Update initializer modifier to prevent reentrancy during initialization](https://github.com/code-423n4/2022-04-jpegd-findings/issues/227)
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Submitted by Dravee_

[package.json#L18-L19](https://github.com/code-423n4/2022-04-jpegd/blob/main/package.json#L18-L19)  
...
*   [https://security.snyk.io/vuln/SNYK-JS-OPENZEPPELINCONTRACTSUPGRADEABLE-2320177](https://security.snyk.io/vuln/SNYK-JS-OPENZEPPELINCONTRACTSUPGRADEABLE-2320177)
*   [https://snyk.io/test/npm/@openzeppelin/contracts-upgradeable/4.3.2#SNYK-JS-OPENZEPPELINCONTRACTSUPGRADEABLE-2320177](https://snyk.io/test/npm/@openzeppelin/contracts-upgradeable/4.3.2#SNYK-JS-OPENZEPPELINCONTRACTSUPGRADEABLE-2320177)
*   [https://snyk.io/test/npm/@openzeppelin/contracts/4.0.0#SNYK-JS-OPENZEPPELINCONTRACTS-2320176](https://snyk.io/test/npm/@openzeppelin/contracts/4.0.0#SNYK-JS-OPENZEPPELINCONTRACTS-2320176)
...
[](#h-04-reentrancy-issue-in-yvaultdeposit)[\[H-04\] Reentrancy issue in `yVault.deposit`](https://github.com/code-423n4/2022-04-jpegd-findings/issues/81)
----------------------------------------------------------------------------------------------------------------------------------------------------------

_Submitted by cmichel_

[yVault.sol#L144-L145](https://github.com/code-423n4/2022-04-jpegd/blob/e72861a9ccb707ced9015166fbded5c97c6991b6/contracts/vaults/yVault/yVault.sol#L144-L145)  
...
[](#h-05-yvaultlpfarming-no-guarantee-jpeg-currentbalance--previousbalance)[\[H-05\] `yVaultLPFarming`: No guarantee JPEG currentBalance > previousBalance](https://github.com/code-423n4/2022-04-jpegd-findings/issues/56)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Submitted by hickuphh3_

[yVaultLPFarming.sol#L169-L170](https://github.com/code-423n4/2022-04-jpegd/blob/main/contracts/farming/yVaultLPFarming.sol#L169-L170)  
...
[](#h-06-setting-new-controller-can-break-yvaultlpfarming)[\[H-06\] Setting new controller can break `YVaultLPFarming`](https://github.com/code-423n4/2022-04-jpegd-findings/issues/80)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Submitted by cmichel_

[yVaultLPFarming.sol#L170](https://github.com/code-423n4/2022-04-jpegd/blob/e72861a9ccb707ced9015166fbded5c97c6991b6/contracts/farming/yVaultLPFarming.sol#L170)  
[yVault.sol#L108](https://github.com/code-423n4/2022-04-jpegd/blob/e72861a9ccb707ced9015166fbded5c97c6991b6/contracts/vaults/yVault/yVault.sol#L108)  
...
[](#h-07-controller-strategy-migration-will-fail)[\[H-07\] Controller: Strategy migration will fail](https://github.com/code-423n4/2022-04-jpegd-findings/issues/57)
--------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Submitted by hickuphh3, also found by rayn_

[Controller.sol#L95](https://github.com/code-423n4/2022-04-jpegd/blob/main/contracts/vaults/yVault/Controller.sol#L95)  
[StrategyPUSDConvex.sol#L266](https://github.com/code-423n4/2022-04-jpegd/blob/main/contracts/vaults/yVault/strategies/StrategyPUSDConvex.sol#L266)  
...
[](#h-08-strategypusdconvexbalanceofjpeg-uses-incorrect-function-signature-while-calling-extrarewardearned-causing-the-function-to-unexpectedly-revert-everytime)[\[H-08\] `StrategyPUSDConvex.balanceOfJPEG` uses incorrect function signature while calling `extraReward.earned`, causing the function to unexpectedly revert everytime](https://github.com/code-423n4/2022-04-jpegd-findings/issues/139)
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#h-09-bad-debts-should-not-continue-to-accrue-interest)[\[H-09\] Bad debts should not continue to accrue interest](https://github.com/code-423n4/2022-04-jpegd-findings/issues/167)
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Submitted by WatchPug_

[NFTVault.sol#L844-L851](https://github.com/code-423n4/2022-04-jpegd/blob/e72861a9ccb707ced9015166fbded5c97c6991b6/contracts/vaults/NFTVault.sol#L844-L851)  
...
[](#m-01-when-_lptoken-is-jpeg-reward-calculation-is-incorrect)[\[M-01\] When \_lpToken is jpeg, reward calculation is incorrect](https://github.com/code-423n4/2022-04-jpegd-findings/issues/1)
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[LPFarming.sol#L141-L154](https://github.com/code-423n4/2022-04-jpegd/blob/main/contracts/farming/LPFarming.sol#L141-L154)  
[LPFarming.sol#L288-L311](https://github.com/code-423n4/2022-04-jpegd/blob/main/contracts/farming/LPFarming.sol#L288-L311)  
...
[](#m-02-nfthelper-contract-allows-owner-to-burn-nfts)[\[M-02\] NFTHelper Contract Allows Owner to Burn NFTs](https://github.com/code-423n4/2022-04-jpegd-findings/issues/47)
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Submitted by Kenshin_

[CryptoPunksHelper.sol#L38](https://github.com/code-423n4/2022-04-jpegd/blob/e72861a9ccb707ced9015166fbded5c97c6991b6/contracts/helpers/CryptoPunksHelper.sol#L38)  
[CryptoPunksHelper.sol#L52](https://github.com/code-423n4/2022-04-jpegd/blob/e72861a9ccb707ced9015166fbded5c97c6991b6/contracts/helpers/CryptoPunksHelper.sol#L52)  
...
[](#m-03-reward-will-be-locked-in-the-farm-if-no-lp-join-the-pool-at-epochstartblock-)[\[M-03\] reward will be locked in the farm if no LP join the pool at epoch.startBlock](https://github.com/code-423n4/2022-04-jpegd-findings/issues/14)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Submitted by TrungOre_

[LPFarming.sol#L214](https://github.com/code-423n4/2022-04-jpegd/blob/e72861a9ccb707ced9015166fbded5c97c6991b6/contracts/farming/LPFarming.sol#L214)  
[LPFarming.sol#L107](https://github.com/code-423n4/2022-04-jpegd/blob/e72861a9ccb707ced9015166fbded5c97c6991b6/contracts/farming/LPFarming.sol#L107)  
...
[](#m-04-setdebtinterestapr-should-accrue-debt-first)[\[M-04\] `setDebtInterestApr` should accrue debt first](https://github.com/code-423n4/2022-04-jpegd-findings/issues/78)
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Submitted by cmichel, also found by pedroais_

[NFTVault.sol#L212](https://github.com/code-423n4/2022-04-jpegd/blob/e72861a9ccb707ced9015166fbded5c97c6991b6/contracts/vaults/NFTVault.sol#L212)  
...
[](#m-05-rewards-will-be-locked-if-user-transfer-directly-to-pool-without-using-deposit-function-)[\[M-05\] Rewards will be locked if user transfer directly to pool without using deposit function](https://github.com/code-423n4/2022-04-jpegd-findings/issues/19)
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Submitted by TrungOre_

[LPFarming.sol#L190](https://github.com/code-423n4/2022-04-jpegd/blob/e72861a9ccb707ced9015166fbded5c97c6991b6/contracts/farming/LPFarming.sol#L190)  
...
[](#m-06-oracle-data-feed-is-insufficiently-validated)[\[M-06\] Oracle data feed is insufficiently validated.](https://github.com/code-423n4/2022-04-jpegd-findings/issues/54)
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[FungibleAssetVaultForDAO.sol#L105](https://github.com/code-423n4/2022-04-jpegd/blob/e72861a9ccb707ced9015166fbded5c97c6991b6/contracts/vaults/FungibleAssetVaultForDAO.sol#L105)  
...
[](#m-07-wrong-calculation-for-yvault-price-per-share-if-decimals--18)[\[M-07\] Wrong calculation for `yVault` price per share if decimals != 18](https://github.com/code-423n4/2022-04-jpegd-findings/issues/117)
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
_NOTE: `units()` helper function was adapted to accept the desired decimals._
...
[](#m-08-_swapuniswapv2-may-use-an-improper-path-which-can-cause-a-loss-of-the-majority-of-the-rewardtokens)[\[M-08\] `_swapUniswapV2` may use an improper `path` which can cause a loss of the majority of the rewardTokens](https://github.com/code-423n4/2022-04-jpegd-findings/issues/157)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Submitted by WatchPug_

[StrategyPUSDConvex.sol#L311-L334](https://github.com/code-423n4/2022-04-jpegd/blob/e72861a9ccb707ced9015166fbded5c97c6991b6/contracts/vaults/yVault/strategies/StrategyPUSDConvex.sol#L311-L334)  
...
[StrategyPUSDConvex.sol#L410-L430](https://github.com/code-423n4/2022-04-jpegd/blob/e72861a9ccb707ced9015166fbded5c97c6991b6/contracts/vaults/yVault/strategies/StrategyPUSDConvex.sol#L410-L430)  
...
[](#m-09-the-nocontract-modifier-does-not-work-as-expected)[\[M-09\] The noContract modifier does not work as expected.](https://github.com/code-423n4/2022-04-jpegd-findings/issues/11)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Submitted by Wayne, also found by hyh, PPrieditis, rayn, smiling_heretic, and Cr4ckM3\_

[yVault.sol#L61](https://github.com/code-423n4/2022-04-jpegd/blob/59e288c27e1ff1b47505fea2e5434a7577d85576/contracts/vaults/yVault/yVault.sol#L61)  
[yVaultLPFarming.sol#L54](https://github.com/code-423n4/2022-04-jpegd/blob/59e288c27e1ff1b47505fea2e5434a7577d85576/contracts/farming/yVaultLPFarming.sol#L54)  
...
[](#m-10-chainlink-pricer-is-using-a-deprecated-api)[\[M-10\] Chainlink pricer is using a deprecated API](https://github.com/code-423n4/2022-04-jpegd-findings/issues/4)
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[FungibleAssetVaultForDAO.sol#L105](https://github.com/code-423n4/2022-04-jpegd/blob/main/contracts/vaults/FungibleAssetVaultForDAO.sol#L105)  
[NFTVault.sol#L459](https://github.com/code-423n4/2022-04-jpegd/blob/main/contracts/vaults/NFTVault.sol#L459)  
...
[](#m-11-division-before-multiplication-may-result-in-no-interest-being-accrued)[\[M-11\] Division before Multiplication May Result In No Interest Being Accrued](https://github.com/code-423n4/2022-04-jpegd-findings/issues/97)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Submitted by AuditsAreUS, also found by minhquanym_

[NFTVault.sol#L590-L595](https://github.com/code-423n4/2022-04-jpegd/blob/e72861a9ccb707ced9015166fbded5c97c6991b6/contracts/vaults/NFTVault.sol#L590-L595)  
...
[](#l-05-fee-in-strategypusdconvexsetperformancefee-should-be-upper-bounded)\[L-05\] Fee in `StrategyPUSDConvex.setPerformanceFee()` should be upper-bounded
------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#l-06-fee-in-nftvaultsetorganizationfeerateshould-be-upper-bounded)\[L-06\] Fee in `NFTVault.setOrganizationFeeRate()`should be upper-bounded
------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#n-01-avoid-floating-pragmas-the-version-should-be-locked-preferably-at--084)\[N-01\] Avoid floating pragmas: the version should be locked (preferably at >= `0.8.4`)
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-01-nftescrow_executetransfer-cheap-contract-deployment-through-clones)\[G-01\] `NFTEscrow._executeTransfer()`: Cheap Contract Deployment Through Clones
-------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-02-lpfarmingnewepoch-l128-and-l133-should-be-unchecked-due-to-parent-ifelse-condition)\[G-02\] `LPFarming.newEpoch()`: L128 and L133 should be unchecked due to parent if/else condition
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-03-lpfarmingwithdraw-l248-should-be-unchecked-due-to-l243)\[G-03\] `LPFarming.withdraw()`: L248 should be unchecked due to L243
-------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-04-lpfarming_withdrawreward-poolinfo_pidaccrewardpershare-should-get-cached)\[G-04\] `LPFarming._withdrawReward()`: `poolInfo[_pid].accRewardPerShare` should get cached
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-05-yvaultlpfarmingwithdraw-l124-should-be-unchecked-due-to-l119)\[G-05\] `yVaultLPFarming.withdraw()`: L124 should be unchecked due to L119
-------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-06-yvaultlpfarming_withdrawreward-accrewardpershare-should-get-cached)\[G-06\] `yVaultLPFarming._withdrawReward()`: `accRewardPerShare` should get cached
---------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-07-jpeglockunlock-use-storage-instead-of-copying-struct-in-memory-l69)\[G-07\] `JPEGLock.unlock()`: use `storage` instead of copying struct in memory L69
---------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-08-fungibleassetvaultfordao_collateralpriceusd-oracle-should-get-cached)\[G-08\] `FungibleAssetVaultForDAO._collateralPriceUsd()`: `oracle` should get cached
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-09-fungibleassetvaultfordao_collateralpriceusd-return-statement-should-be-unchecked)\[G-09\] `FungibleAssetVaultForDAO._collateralPriceUsd()`: return statement should be unchecked
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-10-fungibleassetvaultfordaodeposit-collateralasset-should-get-cached)\[G-10\] `FungibleAssetVaultForDAO.deposit()`: `collateralAsset` should get cached
-------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-11-fungibleassetvaultfordaorepay-l184-should-be-unchecked-due-to-l182)\[G-11\] `FungibleAssetVaultForDAO.repay)`: L184 should be unchecked due to L182
------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-12-fungibleassetvaultfordaowithdraw-l196-should-be-unchecked-due-to-l194)\[G-12\] `FungibleAssetVaultForDAO.withdraw()`: L196 should be unchecked due to L194
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-13-fungibleassetvaultfordaowithdraw-collateralamount-should-get-cached)\[G-13\] `FungibleAssetVaultForDAO.withdraw()`: `collateralAmount` should get cached
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-14-nftvault_normalizeaggregatoranswer-return-statement-should-be-unchecked)\[G-14\] `NFTVault._normalizeAggregatorAnswer()`: return statement should be unchecked
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-15-nftvault_calculateadditionalinterest-totaldebtamount-should-get-cached)\[G-15\] `NFTVault._calculateAdditionalInterest()`: `totalDebtAmount` should get cached
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-16-nftvaultsol-struct-positionpreview-can-be-tightly-packed-to-save-1-storage-slot)\[G-16\] `NFTVault.sol`: `struct PositionPreview` can be tightly packed to save 1 storage slot
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-17-nftvaultshowposition-l659-should-be-unchecked-due-to-l649)\[G-17\] `NFTVault.showPosition()`: L659 should be unchecked due to L649
-------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-18-nftvaultshowposition-positions_nftindexliquidatedat-should-get-cached)\[G-18\] `NFTVault.showPosition()`: `positions[_nftIndex].liquidatedAt` should get cached
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-19-nftvaultshowposition-help-the-optimizer-by-saving-a-storage-variables-reference-instead-of-repeatedly-fetching-it-positions_nftindex)\[G-19\] `NFTVault.showPosition()`: Help the optimizer by saving a storage variable’s reference instead of repeatedly fetching it (`positions[_nftIndex]`)
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-20-nftvaultborrow-totaldebtportion-should-get-cached)\[G-20\] `NFTVault.borrow()`: `totalDebtPortion` should get cached
-----------------------------------------------------------------------------------------------------------------------------
...
[](#g-21-nftvaultrepay-l781-should-be-unchecked-due-to-ternary-operator)\[G-21\] `NFTVault.repay()`: L781 should be unchecked due to ternary operator
-----------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-22-nftvaultrepay-totaldebtportion-and-totaldebtamount-should-get-cached)\[G-22\] `NFTVault.repay()`: `totalDebtPortion` and `totalDebtAmount` should get cached
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-23-controllersetstrategy-boolean-comparison-l87)\[G-23\] `Controller.setStrategy()`: boolean comparison L87
-----------------------------------------------------------------------------------------------------------------
...
[](#g-24-strategypusdconvexbalanceofjpeg-jpeg-should-get-cached)\[G-24\] `StrategyPUSDConvex.balanceOfJPEG()`: `jpeg` should get cached
---------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-25-strategypusdconvexbalanceofjpeg-use-a-return-statement-instead-of-break)\[G-25\] `StrategyPUSDConvex.balanceOfJPEG()`: use a `return` statement instead of `break`
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-26-strategypusdconvexwithdraw-l281-should-be-unchecked-due-to-l279)\[G-26\] `StrategyPUSDConvex.withdraw()`: L281 should be unchecked due to L279
-------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-27-strategypusdconvexharvest-l362-should-be-unchecked-due-to-l359-l360-and-how-performancefee-is-set-l183)\[G-27\] `StrategyPUSDConvex.harvest()`: L362 should be unchecked due to L359-L360 and how performanceFee is set L183
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
[](#g-28-yvaultearn-token-and-controller-should-get-cached)\[G-28\] `yVault.earn()`: `token` and `controller` should get cached
-------------------------------------------------------------------------------------------------------------------------------
...
[](#g-29-yvaultwithdraw-l178-should-be-unchecked-due-to-l177)\[G-29\] `yVault.withdraw()`: L178 should be unchecked due to L177
-------------------------------------------------------------------------------------------------------------------------------
...
[](#g-30-yvaultwithdraw-token-should-get-cached)\[G-30\] `yVault.withdraw()`: `token` should get cached
-------------------------------------------------------------------------------------------------------
...
[](#g-31-yvaultwithdrawjpeg-farm-should-get-cached)\[G-31\] `yVault.withdrawJPEG()`: `farm` should get cached
-------------------------------------------------------------------------------------------------------------
...
[](#g-32-upgrade-pragma-to-at-least-084)\[G-32\] Upgrade pragma to at least 0.8.4
---------------------------------------------------------------------------------
...
[](#g-36-an-arrays-length-should-be-cached-to-save-gas-in-for-loops)\[G-36\] An array’s length should be cached to save gas in for-loops
----------------------------------------------------------------------------------------------------------------------------------------
